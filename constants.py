...
# for key in board:
#     if board[key]["square"] == board2[key]["square"]:
#         print(key)
#     for k in board[key]:
#         if board[key][k][0] != board2[key][k][0] or board[key][k][1] != board2[key][k][1]:
#             print(key)
#     # if board[key][0] != board2[key][0] or board[key][1] != board2[key][1]
# # print(board2 == board)
